                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="logo">
                            ...
                            <div id="logo-container">
                                <i id="icones" class="material-icons prefix small tooltipped" style="padding-right: 50px " data-position="top" data-delay="50" data-tooltip="Adicionar Usuário">person_add</i>
                        ...
                        <li class="bold">
                            <a class="collapsible-header">Funcion�rios</a>
                            <div class="collapsible-body">
                                <ul>
                                    <li><a>Cadastrar Funcion�rio</a></li>
                                    <li><a>...</a></li>
                                    <li><a>...</a></li>
                                </ul>
                            </div>
